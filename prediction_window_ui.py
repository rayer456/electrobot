...
"}")
        ...
        self.buttonLayout.setContentsMargins(-1, -1, 0, -1)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.savedStatus.sizePolicy().hasHeightForWidth())
        self.savedStatus.setSizePolicy(sizePolicy)
        self.savedStatus.setMaximumSize(QtCore.QSize(80, 16777215))
        font = QtGui.QFont()
...
"}")
        ...
        self.buttonLayout.addWidget(self.savedStatus)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.savedStatus.setText(_translate("MainWindow", "Saved"))
